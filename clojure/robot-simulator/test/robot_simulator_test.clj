...
(deftest can-turn
  ...
  (is (= :east (robot-simulator/turn-right :north)))
  (is (= :south (robot-simulator/turn-right :east)))
  (is (= :west (robot-simulator/turn-right :south)))

  (is (= :west (robot-simulator/turn-left :north)))
  (is (= :south (robot-simulator/turn-left :west)))
  (is (= :east (robot-simulator/turn-left :south)))
  (is (= :north (robot-simulator/turn-left :east)))
  )
